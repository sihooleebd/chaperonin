...
import { CATEGORIES, TYPE_COLORS, INPUT_TYPES } from '../data/modules';
  ...
  return (
    <div className="node-props">
      ...
      <div className="props-section">
        ...
        <div className="props-param">
          <select className="props-param-input props-select"
                  value={dataType}
                  onChange={(e) => onChange(node.id, { dataType: e.target.value })}
                  style={{ color }}>
            {INPUT_TYPES.map((t) => (
